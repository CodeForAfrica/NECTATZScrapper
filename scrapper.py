...
try:
	...
	query = "CREATE TABLE " + config.cseeYear2016 + " (SchoolCode, SchoolName, Region, StudentNo, Gender, Division, Civics, History, English, Kiswahili, Geography, BibleKnowledge, BasicMathematics, AdditionalMathematics, Biology, Physics, Chemistry, BookKeeping, Commerce, AgriculturalSc, ElectricalDraugt, ElectricalInsta, ElectricalEngnSc, ElimuYaDiniKiislam, FineArt, ArabicLang, ArchtecturualDrought, BrickworkMasonary, BuildingConstruction, CarpentryJoinery, EngineeringSci, FittingTurning, FoodNutrition, FrenchLang, InformComputer, Plumbing, Music, LiteratureEng, MechanicalDrought, MotorVehicleMech, PaintingSignwriting, PhysicalEducation, RadioTvServing, Serving, TextileDressMaking, TheatreArt, WeldingMetalFabrication, WorkshopTech )"          
